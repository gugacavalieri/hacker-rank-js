...
describe('find-the-point.test.js', () => {
  describe('findPoint()', () => {
    ...
    it('(1,1) and (2,2) should be (3,3)', () => {
      expect(Solution.findPoint(1, 1, 2, 2)).to.deep.equal([3, 3])
    })
    it('(3,3) and (2,2) should be (1,1)', () => {
      expect(Solution.findPoint(3, 3, 2, 2)).to.deep.equal([1, 1])
    })
    it('(0,0) and (-2,-2) should be (-4,-4)', () => {
      expect(Solution.findPoint(0, 0, -2, -2)).to.deep.equal([-4, -4])
    })
  })
})
